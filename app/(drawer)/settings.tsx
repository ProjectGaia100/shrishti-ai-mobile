...
export default function SettingsScreen() {
  ...
  const menuIconColor = colors.textPrimary;
      ...
      <SafeAreaView style={styles.safe} edges={['top']}>
        <Animated.View style={{ flex: 1, opacity: fadeAnim }}>
          ...
          <View style={styles.header}>
            <TouchableOpacity
              onPress={openDrawer}
              style={[styles.menuBtn, { backgroundColor: isDark ? 'rgba(255,255,255,0.1)' : 'rgba(0,0,0,0.07)' }]}
            >
              <Ionicons name="menu" size={24} color={menuIconColor} />
            </TouchableOpacity>
